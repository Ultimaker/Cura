...
from UM.Qt.Factory.QtCore import Qt, QCoreApplication, QTimer
from UM.Qt.Factory.QtGui import QPixmap, QColor, QFont, QPen, QPainter
from UM.Qt.Factory.QtWidgets import QSplashScreen
