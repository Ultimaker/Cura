        ...
        for (file, material, profile) in result:
            ...
            with open(os.path.join(path, material, "material.ini"), "w") as f:
                ...
                if material_types.has_key(material):
                    ...
                    if ((material == "nGen" and machine_type.startswith("lulzbot_mini")) or \
                        (material == "nGen" and machine_type.startswith("lulzbot_TAZ_4")) or \
                        (material == "nGen" and machine_type.startswith("lulzbot_TAZ_5")) or \
