            ...
            Column
            {
                ...
                Repeater
                {
                    ...
                    Component.onCompleted:
                    {
                        ...
                        projectsModel.append({ name: "Qt6", description: catalog.i18nc("@label Description for application dependency", "GUI framework"), license: "LGPLv3", license_full: "", url: "https://code.qt.io/cgit/qt/qtbase.git/" });
