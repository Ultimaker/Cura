...
import json
from typing import List, Any, Optional, Union, cast, Callable, TypeVar, Dict, Type
...
from cura.UltimakerCloud.ApiClient import ApiClient
from cura.UltimakerCloud.BaseModel import BaseModel
from cura.UltimakerCloud.CloudError import CloudError
from cura.UltimakerCloud.PaginationManager import PaginationManager
from cura.UltimakerCloud.PaginationLinks import PaginationLinks
...
class DigitalFactoryApiClient(ApiClient):
    ...
    def __init__(self, application: CuraApplication, on_error: Callable[[List[CloudError]], None], projects_limit_per_page: Optional[int] = None) -> None:
        ...
        """
        super().__init__(application, on_error)
    ...
    def checkUserHasAccess(self, callback: Callable) -> None:
        ...
        self.sendGet(f"{self.CURA_API_ROOT}/feature_budgets",
                     callbackWrap,
                     DigitalFactoryFeatureBudgetResponse,
                     callbackWrap)
    ...
    def checkUserCanCreateNewLibraryProject(self, callback: Callable) -> None:
        ...
        if self._library_max_private_projects is not None and self._library_max_private_projects > 0:
            ...
            self.sendGet(url, callbackWrap, DigitalFactoryProjectResponse, callbackWrap)
        else:
    ...
    def getProject(self, library_project_id: str, on_finished: Callable[[DigitalFactoryProjectResponse], Any], failed: Callable) -> None:
        ...
        self.sendGet(url, on_finished, DigitalFactoryProjectResponse, failed)
    ...
    def getProjectsFirstPage(self, search_filter: str, on_finished: Callable[[List[DigitalFactoryProjectResponse]], Any], failed: Callable) -> None:
        ...
        self.sendGet(url, on_finished, DigitalFactoryProjectResponse, failed, self._projects_pagination_mgr)
    ...
    def getListOfFilesInProject(self, library_project_id: str, on_finished: Callable[[List[DigitalFactoryFileResponse]], Any], failed: Callable) -> None:
        ...
        self.sendGet(url, on_finished, DigitalFactoryFileResponse, failed)
    ...
    def requestUpload3MF(self, request: DFLibraryFileUploadRequest,
        ...
        self.sendPut(url, data, on_finished, DFLibraryFileUploadResponse, on_error)
    ...
    def requestUploadUFP(self, request: DFPrintJobUploadRequest,
        ...
        data = json.dumps({"data": request.toDict()}).encode()
        self.sendPut(url, data, on_finished, DFPrintJobUploadResponse, on_error)
    ...
    def uploadExportedFileData(self,
        ...
        self._file_uploader = DFFileUploader(HttpRequestManager.getInstance(),
                                             df_file_upload_response,
                                             mesh,
                                             on_finished,
                                             on_success,
                                             on_progress,
    ...
    def createNewProject(self, project_name: str, on_finished: Callable[[DigitalFactoryProjectResponse], Any], on_error: Callable) -> None:
        ...
        self.sendPut(url, data, on_finished, DigitalFactoryProjectResponse, on_error)
