...
>>>>>>> Stashed changes
        ...
        if bool(self.getSettingValueByKey("support_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Support]\n"
<<<<<<< Updated upstream
            setting_data += ";Enable Support: " + str(extruder[num].getProperty("support_enable", "value")) + "\n"
            if bool(extruder[num].getProperty("support_enable", "value")):
=======
...
>>>>>>> Stashed changes
                ...
                try:
                    ...
                    all
<<<<<<< Updated upstream
                setting_data += ";Adhesion Skirt Height: " + str(MyCura.getProperty("skirt_height", "value")) + "mm\n"
                setting_data += ";Adhesion Skirt Gap: " + str(MyCura.getProperty("skirt_gap", "value")) + "mm\n"
                setting_data += ";Adhesion Brim Width: " + str(MyCura.getProperty("brim_width", "value")) + "mm\n"
                setting_data += ";Adhesion Brim Gap: " + str(MyCura.getProperty("brim_gap", "value")) + "mm\n"
                ...
                setting_data += ";Raft Margin: " + str(MyCura.getProperty("raft_margin", "value")) + "mm\n"
