    ...
    Item
    {
        ...
        Item  // Text part
        {
            ...
            UM.Label
            {
                ...
                text: catalog.i18nc("@text:window", "BCN3D Stratos collects anonymous data in order to improve the print quality and user experience. Below is an example of all the data that is shared:")
