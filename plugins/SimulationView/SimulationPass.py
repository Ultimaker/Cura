    ...
    def render(self):
        ...
        for node in DepthFirstIterator(self._scene.getRoot()):
            ...
            if isinstance(node, ToolHandle):
                ...
                if self._layer_view.getCurrentLayer() > -1 and (
                        (not self._layer_view._only_show_top_layers) or (not self._layer_view.getCompatibilityMode())):
                    start = 0
                    end = 0
                    ...
                    current_layer_end = end + int(
                        self._layer_view.getCurrentPath()) * 2  # Because each point is used twice
