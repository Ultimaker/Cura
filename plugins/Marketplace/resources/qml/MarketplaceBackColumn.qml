...
Item
{
    ...
    width: UM.Theme.getSize("marketplace_back_column").width
    anchors
    {
        top: parent.top
        left: parent.left
    ...
    Button
    {
        ...
        width: UM.Theme.getSize("marketplace_back_button").width
        height: UM.Theme.getSize("marketplace_back_button").height
        onClicked:
        {
            marketplace.viewPage = "overview"
            marketplace.filterModelByProp("packages", "type", marketplace.viewCategory)
        }
        style: ButtonStyle
        {
