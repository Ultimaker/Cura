...
Packages
{
    ...
    bannerText: catalog.i18nc("@text", "Manage your BCN3D Stratos plugins and material profiles here. Make sure to keep your plugins up to date and backup your setup regularly.")
