...
UM.Dialog
{
    ...
    title: catalog.i18nc("@title:window", "Confirm uninstall") + marketplace.pluginToUninstall
    ...
    Column
    {
        ...
        Label
        {
            ...
            text:
            {
                ...
                var machines_with_materials = marketplace.uninstallUsedMaterials
                var machines_with_qualities = marketplace.uninstallUsedQualities
        ...
        Item {
            ...
            Button {
                ...
                isDefault: true
                onClicked: marketplace.closeConfirmResetDialog()
            }
            ...
            Button {
                ...
                anchors.right: parent.right
                onClicked: marketplace.resetMaterialsQualitiesAndUninstall()
            }
        }
    }
}
