...
Item
{
    ...
    Item
    {
        ...
        height: UM.Theme.getSize("marketplace_detail_header").height
        Image
        {
            id: thumbnail
            width: UM.Theme.getSize("marketplace_thumbnail_medium").width
            height: UM.Theme.getSize("marketplace_thumbnail_medium").height
