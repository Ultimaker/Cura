...
Item
{
    ...
    height: UM.Theme.getSize("marketplace_action_button").height
    ...
    AnimatedImage
    {
        ...
        width: UM.Theme.getSize("marketplace_loader").width
        height: UM.Theme.getSize("marketplace_loader").height
