...
def register(app):
    ...
    return {
        "extension": USBPrinterOutputDeviceManager.USBPrinterOutputDeviceManager.getInstance(),
        "machine_action": ConnectUSBAction.ConnectUSBAction(),
        "output_device": USBPrinterOutputDeviceManager.USBPrinterOutputDeviceManager.getInstance()
    }
