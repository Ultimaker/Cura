...
class AutoDetectBaudJob(Job):
    ...
    def run(self) -> None:
        ...
        wait_response_timeouts = [4, 15, 30]
        ...
        for retry in range(tries):
            for baud_rate in self._all_baud_rates:
                ...
                try:
                    ...
                    Logger.logException("w", "serial.write: Exception")
                    continue
...
# Using serial.readline will not work here due to all the noise received during baudrate mismatch
# Replaced with state machinery which will work
