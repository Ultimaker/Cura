...
# How to translate variants of specific machines from the old version to the new.
...
class VersionUpgrade21to22(VersionUpgrade):
    ...
    # Gets the fallback quality to use for a specific machine-variant-material combination.
